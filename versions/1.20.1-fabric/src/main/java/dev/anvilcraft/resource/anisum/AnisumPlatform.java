...
public class AnisumPlatform implements ModInitializer {
    ...
    private static void serverStarted(MinecraftServer server) {
        AnisumPlatform.lootLoaded(server, server.getLootData());
    }
    ...
    private static void endDataPackReload(
        ...
        LootDataManager lootTables = server.getLootData();
        AnisumPlatform.lootLoaded(server, lootTables);
    }

    private static void lootLoaded(@Nonnull MinecraftServer server, @Nonnull LootDataManager lootTables) {
